        ...
        if (rst) begin
            ...
            STREAM: begin
                ...
                if(pixel_count >= start_window_pixel_count-2 && (col_cnt>=KERNEL_SIZE-2 && col_cnt<=IMAGE_SIZE-1)) begin
                    ...
                    if (col_cnt >= KERNEL_SIZE && pixel_count >= start_window_pixel_count && col_cnt<=IMAGE_SIZE-2) begin 
            ...
            PAUSE: begin 
                ...
                if (col_cnt>= KERNEL_SIZE-1 && pixel_count >= start_window_pixel_count ) begin 
